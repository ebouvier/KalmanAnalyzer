// -*- C++ -*-
//
// Package:    KalmanAnalyzer_El
// Class:      KalmanAnalyzer_El
// 
/**\class KalmanAnalyzer_El KalmanAnalyzer_El.cc UserCode/KalmanAnalyzer_El/src/KalmanAnalyzer_El.cc
...
class KalmanAnalyzer_El : public edm::EDAnalyzer {
  public:
    explicit KalmanAnalyzer_El(const edm::ParameterSet&);
    ~KalmanAnalyzer_El();
...
//
KalmanAnalyzer_El::KalmanAnalyzer_El(const edm::ParameterSet& iConfig)
...
KalmanAnalyzer_El::~KalmanAnalyzer_El()
{
...
// ------------ method called for each event  ------------
  void
KalmanAnalyzer_El::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  nEvts++;
  hasGoodMuons = false;
...
// ------------ method called when starting to processes a run  ------------
  void 
KalmanAnalyzer_El::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
  void 
KalmanAnalyzer_El::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
  void 
KalmanAnalyzer_El::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
  void 
KalmanAnalyzer_El::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
KalmanAnalyzer_El::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(KalmanAnalyzer_El);
