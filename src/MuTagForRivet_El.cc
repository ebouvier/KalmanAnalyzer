// -*- C++ -*-
//
// Package:    MuTagForRivet_El
// Class:      MuTagForRivet_El
// 
/**\class MuTagForRivet_El MuTagForRivet_El.cc UserCode/KalmanAnalyzer/src/MuTagForRivet_El.cc
...
class MuTagForRivet_El : public edm::EDAnalyzer {
  public:
    explicit MuTagForRivet_El(const edm::ParameterSet&);
    ~MuTagForRivet_El();
...
//
MuTagForRivet_El::MuTagForRivet_El(const edm::ParameterSet& iConfig) :
...
MuTagForRivet_El::~MuTagForRivet_El()
{
...
// ------------ method called for each event  ------------
  void
MuTagForRivet_El::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  nEvts++;
  ...
  if (isGoodEvt && passTrigger) {
    ...
    _CSV = -1; 
    _vecP[0] = -1000.; _vecP[1] = -1000.; _vecP[2] = -1000.; _vecP[3] = -1000.;
    _Nch = -1; 
    _sump = -1.; 
    _sumpt = -1.; 
    _sumpvec.SetPtEtaPhiM(0.,0.,0.,0.);
    _tr1[0] = -1000.; _tr1[1] = -1000.; _tr1[2] = -1000.; _tr1[3] = -1000.;
    _tr2[0] = -1000.; _tr2[1] = -1000.; _tr2[2] = -1000.; _tr2[3] = -1000.;
    _tr3[0] = -1000.; _tr3[1] = -1000.; _tr3[2] = -1000.; _tr3[3] = -1000.;
    ...
    for (pat::JetCollection::iterator it = jets.begin(); it != jets.end(); ++it)  {
      ...
      if (fabs(p_D0optcombi.Pt()) > 1e-10) {
        ...
        if (p_D0optcombi.M() > 1.7 && p_D0optcombi.M() < 2.) 
          _h_BMomentumClean->Fill(p_Boptcombi.M());
          _h_BMassClean->Fill(p_Boptcombi.P());
      }
    } // jet loop
    _t_bjets->Fill();
  }
...
// ------------ method called when starting to processes a run  ------------
  void 
MuTagForRivet_El::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
  void 
MuTagForRivet_El::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
  void 
MuTagForRivet_El::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
  void 
MuTagForRivet_El::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
MuTagForRivet_El::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MuTagForRivet_El);
