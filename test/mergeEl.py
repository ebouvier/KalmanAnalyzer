...
crabFolders = [name for name in os.listdir("crab_tasks/"+options.date) if os.path.isdir(os.path.join("crab_tasks/"+options.date, name)) and (name.startswith("crab_Data_El") or name.startswith("crab_Data_SingleEl"))]

outputName = "crab_results/"+options.date+"/"+"D0ForRivet_El_merged.root" 
