...
if options.type.lower() == "d0":
    ...
    if os.path.isfile("MuTagForRivet_El_merged.root") and os.path.isfile("MuTagForRivet_Mu_merged.root"):
        os.system("hadd MuTagForRivet_Data_merged.root MuTagForRivet_El_merged.root MuTagForRivet_Mu_merged.root");  
        print("MuTagForRivet_Data_merged.root has been produced")
    else:
        print("can't produce MuTagForRivet_Data_merged.root")
