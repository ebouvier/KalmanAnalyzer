...
//---------------------------------------------------------------
{
  ...
  if (isCSVbased)
    std::cout << "hadd MuTagForRivet_csv_Data_merged.root MuTagForRivet_csv_El_merged.root MuTagForRivet_csv_Mu_merged.root" << std::endl;
  else 
    std::cout << "hadd MuTagForRivet_pT_Data_merged.root MuTagForRivet_pT_El_merged.root MuTagForRivet_pT_Mu_merged.root" << std::endl;
  getchar();
  */
  if (isCSVbased) {
    ...
    fi_data_name = fi_data_name + "/MuTagForRivet_pT_Data_merged.root";
    fi_sl_name = fi_sl_name + "/MuTagForRivet_pT_TTJets_SemiLeptMGDecays.root";
    fi_dl_name = fi_dl_name + "/MuTagForRivet_pT_TTJets_FullLeptMGDecays.root";
  }
  ...
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "CSV-b-jets", "CSV discriminant", 0., 0.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "TransverseMomentum-b-jets", "p(jets) (GeV/c)", 0., 300.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "Nch-b-jets", "Tracks multiplicity", 0., 20.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "Sump-b-jets", "Scalar sum of tracks momenta (GeV/c)", 0., 400.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "VectorialSump-b-jets", "Vectorial sum of tracks momenta (GeV/c)", 0., 400.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "Highestp-b-jets", "Highest track momentum (GeV/c)", 0., 200.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "Sum2p-b-jets", "Scalar sum of the 2 highest tracks momenta (GeV/c)", 0., 0.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "Sum3p-b-jets", "Scalar sum of the 3 highest tracks momenta (GeV/c)", 0., 0.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "R1-b-jets", "R_{1}", 0., 0.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "R2-b-jets", "R_{2}", 0., 0.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "R3-b-jets", "R_{3}", 0., 0.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "D0Mass-b-jets", "m(D^{0}#rightarrow#kappa^{+}#pi^{-}) (GeV/c^{2})", 0., 0.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "D0p-b-jets", "p(D^{0}#rightarrow#kappa^{+}#pi^{-}) (GeV/c)", 0., 0.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "BMomentum-nobias-b-jets", "p(#kappa^{+}#pi^{-}+#mu^{-}) (GeV/c)", 0., 350.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "BMass-nobias-b-jets", "M(#kappa^{+}#pi^{-}+#mu^{-}) (GeV/c^{2})", 0., 0.);
  plotHisto(inBatch, date, isCSVbased, fi_data, fi_sl, fi_dl, "Tagged jets", "Muonp-nobias-b-jets", "p(#mu) (GeV/c)", 0., 0.);
