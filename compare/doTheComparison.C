...
//---------------------------------------------------------------
int doTheComparison(bool inBatch = true, TString date = "")
//---------------------------------------------------------------
{
  using namespace RooFit;
...
//  h_B_unmatched_D0consMass->GetXaxis()->SetRangeUser(0,5);
  ...
  h1_style(h_B_unmatched_D0consMass, 38, 38, 3003, -1111., -1111., 510, 510, 38, 1.2, 1, "D^{0} mass (GeV/c^{2})");
...
//  h_B_unmatched_D0optcombiMass->GetXaxis()->SetRangeUser(0,5);
  ...
  h1_style(h_B_unmatched_D0optcombiMass, 38, 38, 3003, -1111., -1111., 510, 510, 38, 1.2, 1, "D^{0} mass (GeV/c^{2})");
  ...
  cn_B_unmatched_D0optcombiMass->SaveAs("Plots"+date+"/B_unmatched_D0optcombiMass.pdf");

  if (!inBatch) getchar();
  delete cn_B_unmatched_D0consMass; delete cn_B_unmatched_D0optcombiMass;
  ...
  RooDataHist dh_B_unmatched_D0consMass_zoom("datahist","datahist",RooArgList(x_B_unmatched_D0consMass_zoom),h_B_unmatched_D0consMass_zoom,1.);
  
  // Signal+Background pdf
  RooRealVar mean_B_unmatched_D0consMass_zoom("mean","mean",1.86484,1.84554,1.88414);
  RooRealVar sigma_B_unmatched_D0consMass_zoom("sigma","sigma",0.0193,0.01,0.03);
  RooRealVar lambda_B_unmatched_D0consMass_zoom("lambda", "slope", -2., -5., -1.5);
  RooGaussian sig_B_unmatched_D0consMass_zoom("sig","gaussian signal",x_B_unmatched_D0consMass_zoom,mean_B_unmatched_D0consMass_zoom,sigma_B_unmatched_D0consMass_zoom);
  RooExponential bck_B_unmatched_D0consMass_zoom("bck", "exponential background", x_B_unmatched_D0consMass_zoom, lambda_B_unmatched_D0consMass_zoom);
  RooRealVar nsig_B_unmatched_D0consMass_zoom("nsig","number of signal events",0.1*h_B_unmatched_D0consMass_zoom->Integral(),0.,h_B_unmatched_D0consMass_zoom->Integral());
  RooRealVar nbck_B_unmatched_D0consMass_zoom("nbck","number of background events",0.9*h_B_unmatched_D0consMass_zoom->Integral(),0.,h_B_unmatched_D0consMass_zoom->Integral());
  RooAddPdf model_B_unmatched_D0consMass_zoom("model","model",RooArgList(sig_B_unmatched_D0consMass_zoom,bck_B_unmatched_D0consMass_zoom),RooArgList(nsig_B_unmatched_D0consMass_zoom,nbck_B_unmatched_D0consMass_zoom)) ;

  // Fit
  model_B_unmatched_D0consMass_zoom.fitTo(dh_B_unmatched_D0consMass_zoom);
  double mass_B_unmatched_D0consMass_zoom     = mean_B_unmatched_D0consMass_zoom.getVal();
  double masserr_B_unmatched_D0consMass_zoom  = mean_B_unmatched_D0consMass_zoom.getError();
  double width_B_unmatched_D0consMass_zoom    = sigma_B_unmatched_D0consMass_zoom.getVal();
  double widtherr_B_unmatched_D0consMass_zoom = sigma_B_unmatched_D0consMass_zoom.getError();
  double Nsig_B_unmatched_D0consMass_zoom  = nsig_B_unmatched_D0consMass_zoom.getVal();
  double dNsig_B_unmatched_D0consMass_zoom = nsig_B_unmatched_D0consMass_zoom.getError();
  double Nbck_B_unmatched_D0consMass_zoom  = nbck_B_unmatched_D0consMass_zoom.getVal();
  double dNbck_B_unmatched_D0consMass_zoom = nbck_B_unmatched_D0consMass_zoom.getError();
  double *SNR_B_unmatched_D0consMass_zoom = new double[2];
  SNR_B_unmatched_D0consMass_zoom[0] = Nsig_B_unmatched_D0consMass_zoom*pow(Nbck_B_unmatched_D0consMass_zoom,-0.5);
  SNR_B_unmatched_D0consMass_zoom[1]  = dNsig_B_unmatched_D0consMass_zoom*pow(Nbck_B_unmatched_D0consMass_zoom,-0.5) + 0.5*SNR_B_unmatched_D0consMass_zoom[0]*dNbck_B_unmatched_D0consMass_zoom/Nbck_B_unmatched_D0consMass_zoom;
  std::cout << "\nSignal mean = " << mass_B_unmatched_D0consMass_zoom << " +/- " << masserr_B_unmatched_D0consMass_zoom << std::endl;
  std::cout << "Signal width = " << width_B_unmatched_D0consMass_zoom << " +/- " << widtherr_B_unmatched_D0consMass_zoom << "\n" << std::endl;
  std::cout << "Nsig = " << Nsig_B_unmatched_D0consMass_zoom << " +/- " << dNsig_B_unmatched_D0consMass_zoom << std::endl;
  std::cout << "Nbck = " << Nbck_B_unmatched_D0consMass_zoom << " +/- " << dNbck_B_unmatched_D0consMass_zoom << std::endl;
  std::cout << "SNR  = " << SNR_B_unmatched_D0consMass_zoom[0] << " +/- " << SNR_B_unmatched_D0consMass_zoom[1] << "\n" << std::endl;

  TPaveText* fit_tex_B_unmatched_D0consMass_zoom = new TPaveText(0.7,0.82,0.91,0.91,"BRNDC");
  fit_tex_B_unmatched_D0consMass_zoom->AddText(TString::Format("N_{\"sig\"} = %5.0f #pm %3.0f", Nsig_B_unmatched_D0consMass_zoom, dNsig_B_unmatched_D0consMass_zoom));
  fit_tex_B_unmatched_D0consMass_zoom->AddText(TString::Format("N_{\"bck\"} = %5.0f #pm %3.0f", Nbck_B_unmatched_D0consMass_zoom, dNbck_B_unmatched_D0consMass_zoom));
//  fit_tex_B_unmatched_D0consMass_zoom->AddText(TString::Format("N_{sig}/#sqrt{N_{bck}} = %2.1f #pm %2.1f", SNR_B_unmatched_D0consMass_zoom[0], SNR_B_unmatched_D0consMass_zoom[1]));
  fit_tex_B_unmatched_D0consMass_zoom->SetTextFont(43);
  fit_tex_B_unmatched_D0consMass_zoom->SetFillColor(0);
  fit_tex_B_unmatched_D0consMass_zoom->SetTextSize(TITLE_FONTSIZE - 6);

  // Plot
  RooPlot* frame_B_unmatched_D0consMass_zoom = x_B_unmatched_D0consMass_zoom.frame();
  dh_B_unmatched_D0consMass_zoom.plotOn(frame_B_unmatched_D0consMass_zoom,MarkerColor(38),LineColor(38));
  model_B_unmatched_D0consMass_zoom.plotOn(frame_B_unmatched_D0consMass_zoom,LineColor(38));

  TCanvas* cn_B_unmatched_D0consMass_zoom = new TCanvas("cn_B_unmatched_D0consMass_zoom","cn_B_unmatched_D0consMass_zoom",800,800);
  ...
  cn_B_unmatched_D0consMass_zoom->SaveAs("Plots"+date+"/B_unmatched_D0consMass_zoom.pdf");
  ...
  RooDataHist dh_B_unmatched_D0optcombiMass_zoom("datahist","datahist",RooArgList(x_B_unmatched_D0optcombiMass_zoom),h_B_unmatched_D0optcombiMass_zoom,1.);
  
  // Signal+Background pdf
  RooRealVar mean_B_unmatched_D0optcombiMass_zoom("mean","mean",1.86484,1.84554,1.88414);
  RooRealVar sigma_B_unmatched_D0optcombiMass_zoom("sigma","sigma",0.0193,0.01,0.03);
  RooRealVar lambda_B_unmatched_D0optcombiMass_zoom("lambda", "slope", -1.7, -5., -0.7);
  RooGaussian sig_B_unmatched_D0optcombiMass_zoom("sig","gaussian signal",x_B_unmatched_D0optcombiMass_zoom,mean_B_unmatched_D0optcombiMass_zoom,sigma_B_unmatched_D0optcombiMass_zoom);
  RooExponential bck_B_unmatched_D0optcombiMass_zoom("bck", "exponential background", x_B_unmatched_D0optcombiMass_zoom, lambda_B_unmatched_D0optcombiMass_zoom);
  RooRealVar nsig_B_unmatched_D0optcombiMass_zoom("nsig","number of signal events",0.1*h_B_unmatched_D0optcombiMass_zoom->Integral(),0.,h_B_unmatched_D0optcombiMass_zoom->Integral());
  RooRealVar nbck_B_unmatched_D0optcombiMass_zoom("nbck","number of background events",0.9*h_B_unmatched_D0optcombiMass_zoom->Integral(),0.,h_B_unmatched_D0optcombiMass_zoom->Integral());
  RooAddPdf model_B_unmatched_D0optcombiMass_zoom("model","model",RooArgList(sig_B_unmatched_D0optcombiMass_zoom,bck_B_unmatched_D0optcombiMass_zoom),RooArgList(nsig_B_unmatched_D0optcombiMass_zoom,nbck_B_unmatched_D0optcombiMass_zoom)) ;

  // Fit
  model_B_unmatched_D0optcombiMass_zoom.fitTo(dh_B_unmatched_D0optcombiMass_zoom);
  double mass_B_unmatched_D0optcombiMass_zoom     = mean_B_unmatched_D0optcombiMass_zoom.getVal();
  double masserr_B_unmatched_D0optcombiMass_zoom  = mean_B_unmatched_D0optcombiMass_zoom.getError();
  double width_B_unmatched_D0optcombiMass_zoom    = sigma_B_unmatched_D0optcombiMass_zoom.getVal();
  double widtherr_B_unmatched_D0optcombiMass_zoom = sigma_B_unmatched_D0optcombiMass_zoom.getError();
  double Nsig_B_unmatched_D0optcombiMass_zoom  = nsig_B_unmatched_D0optcombiMass_zoom.getVal();
  double dNsig_B_unmatched_D0optcombiMass_zoom = nsig_B_unmatched_D0optcombiMass_zoom.getError();
  double Nbck_B_unmatched_D0optcombiMass_zoom  = nbck_B_unmatched_D0optcombiMass_zoom.getVal();
  double dNbck_B_unmatched_D0optcombiMass_zoom = nbck_B_unmatched_D0optcombiMass_zoom.getError();
  double *SNR_B_unmatched_D0optcombiMass_zoom = new double[2];
  SNR_B_unmatched_D0optcombiMass_zoom[0] = Nsig_B_unmatched_D0optcombiMass_zoom*pow(Nbck_B_unmatched_D0optcombiMass_zoom,-0.5);
  SNR_B_unmatched_D0optcombiMass_zoom[1]  = dNsig_B_unmatched_D0optcombiMass_zoom*pow(Nbck_B_unmatched_D0optcombiMass_zoom,-0.5) + 0.5*SNR_B_unmatched_D0optcombiMass_zoom[0]*dNbck_B_unmatched_D0optcombiMass_zoom/Nbck_B_unmatched_D0optcombiMass_zoom;
  std::cout << "\nSignal mean = " << mass_B_unmatched_D0optcombiMass_zoom << " +/- " << masserr_B_unmatched_D0optcombiMass_zoom << std::endl;
  std::cout << "Signal width = " << width_B_unmatched_D0optcombiMass_zoom << " +/- " << widtherr_B_unmatched_D0optcombiMass_zoom << "\n" << std::endl;
  std::cout << "Nsig = " << Nsig_B_unmatched_D0optcombiMass_zoom << " +/- " << dNsig_B_unmatched_D0optcombiMass_zoom << std::endl;
  std::cout << "Nbck = " << Nbck_B_unmatched_D0optcombiMass_zoom << " +/- " << dNbck_B_unmatched_D0optcombiMass_zoom << std::endl;
  std::cout << "SNR  = " << SNR_B_unmatched_D0optcombiMass_zoom[0] << " +/- " << SNR_B_unmatched_D0optcombiMass_zoom[1] << "\n" << std::endl;

  TPaveText* fit_tex_B_unmatched_D0optcombiMass_zoom = new TPaveText(0.7,0.82,0.91,0.91,"BRNDC");
  fit_tex_B_unmatched_D0optcombiMass_zoom->AddText(TString::Format("N_{\"sig\"} = %5.0f #pm %3.0f", Nsig_B_unmatched_D0optcombiMass_zoom, dNsig_B_unmatched_D0optcombiMass_zoom));
  fit_tex_B_unmatched_D0optcombiMass_zoom->AddText(TString::Format("N_{\"bck\"} = %5.0f #pm %3.0f", Nbck_B_unmatched_D0optcombiMass_zoom, dNbck_B_unmatched_D0optcombiMass_zoom));
//  fit_tex_B_unmatched_D0optcombiMass_zoom->AddText(TString::Format("N_{sig}/#sqrt{N_{bck}} = %2.1f #pm %2.1f", SNR_B_unmatched_D0optcombiMass_zoom[0], SNR_B_unmatched_D0optcombiMass_zoom[1]));
  fit_tex_B_unmatched_D0optcombiMass_zoom->SetTextFont(43);
  fit_tex_B_unmatched_D0optcombiMass_zoom->SetFillColor(0);
  fit_tex_B_unmatched_D0optcombiMass_zoom->SetTextSize(TITLE_FONTSIZE - 6);

  // Plot
  RooPlot* frame_B_unmatched_D0optcombiMass_zoom = x_B_unmatched_D0optcombiMass_zoom.frame();
  dh_B_unmatched_D0optcombiMass_zoom.plotOn(frame_B_unmatched_D0optcombiMass_zoom,MarkerColor(38),LineColor(38));
  model_B_unmatched_D0optcombiMass_zoom.plotOn(frame_B_unmatched_D0optcombiMass_zoom,LineColor(38));

  TCanvas* cn_B_unmatched_D0optcombiMass_zoom = new TCanvas("cn_B_unmatched_D0optcombiMass_zoom","cn_B_unmatched_D0optcombiMass_zoom",800,800);
  ...
  cn_B_unmatched_D0optcombiMass_zoom->SaveAs("Plots"+date+"/B_unmatched_D0optcombiMass_zoom.pdf");

  if (!inBatch) getchar();
  delete cn_B_unmatched_D0optcombiMass_zoom; 
  ...
  TLegend *leg_B_D0unbias_zoom = new TLegend(0.65,0.72,0.94,0.92);
  ...
  TLegend *leg_B_D0bias_zoom = new TLegend(0.65,0.72,0.94,0.92);
  ...
  RooRealVar x_B_unmatched_D0Mass_zoom("mass","D^{0} mass",1.7,2.,"GeV/c^{2}");
  RooDataHist dh_B_unmatched_D0Mass_zoom("datahist","datahist",RooArgList(x_B_unmatched_D0Mass_zoom),h_B_unmatched_D0Mass_zoom,1.);
  
  // Signal+Background pdf
  RooRealVar mean_B_unmatched_D0Mass_zoom("mean","mean",1.86484,1.84554,1.88414);
  RooRealVar sigma_B_unmatched_D0Mass_zoom("sigma","sigma",0.0193,0.01,0.03);
  RooRealVar lambda_B_unmatched_D0Mass_zoom("lambda", "slope", -2., -5., -1.5);
  RooGaussian sig_B_unmatched_D0Mass_zoom("sig","gaussian signal",x_B_unmatched_D0Mass_zoom,mean_B_unmatched_D0Mass_zoom,sigma_B_unmatched_D0Mass_zoom);
  RooExponential bck_B_unmatched_D0Mass_zoom("bck", "exponential background", x_B_unmatched_D0Mass_zoom, lambda_B_unmatched_D0Mass_zoom);
  RooRealVar nsig_B_unmatched_D0Mass_zoom("nsig","number of signal events",0.1*h_B_unmatched_D0Mass_zoom->Integral(),0.,h_B_unmatched_D0Mass_zoom->Integral());
  RooRealVar nbck_B_unmatched_D0Mass_zoom("nbck","number of background events",0.9*h_B_unmatched_D0Mass_zoom->Integral(),0.,h_B_unmatched_D0Mass_zoom->Integral());
  RooAddPdf model_B_unmatched_D0Mass_zoom("model","model",RooArgList(sig_B_unmatched_D0Mass_zoom,bck_B_unmatched_D0Mass_zoom),RooArgList(nsig_B_unmatched_D0Mass_zoom,nbck_B_unmatched_D0Mass_zoom)) ;

  // Fit
  model_B_unmatched_D0Mass_zoom.fitTo(dh_B_unmatched_D0Mass_zoom);
  double mass_B_unmatched_D0Mass_zoom     = mean_B_unmatched_D0Mass_zoom.getVal();
  double masserr_B_unmatched_D0Mass_zoom  = mean_B_unmatched_D0Mass_zoom.getError();
  double width_B_unmatched_D0Mass_zoom    = sigma_B_unmatched_D0Mass_zoom.getVal();
  double widtherr_B_unmatched_D0Mass_zoom = sigma_B_unmatched_D0Mass_zoom.getError();
  double Nsig_B_unmatched_D0Mass_zoom  = nsig_B_unmatched_D0Mass_zoom.getVal();
  double dNsig_B_unmatched_D0Mass_zoom = nsig_B_unmatched_D0Mass_zoom.getError();
  double Nbck_B_unmatched_D0Mass_zoom  = nbck_B_unmatched_D0Mass_zoom.getVal();
  double dNbck_B_unmatched_D0Mass_zoom = nbck_B_unmatched_D0Mass_zoom.getError();
  double *SNR_B_unmatched_D0Mass_zoom = new double[2];
  SNR_B_unmatched_D0Mass_zoom[0] = Nsig_B_unmatched_D0Mass_zoom*pow(Nbck_B_unmatched_D0Mass_zoom,-0.5);
  SNR_B_unmatched_D0Mass_zoom[1]  = dNsig_B_unmatched_D0Mass_zoom*pow(Nbck_B_unmatched_D0Mass_zoom,-0.5) + 0.5*SNR_B_unmatched_D0Mass_zoom[0]*dNbck_B_unmatched_D0Mass_zoom/Nbck_B_unmatched_D0Mass_zoom;
  std::cout << "\nSignal mean = " << mass_B_unmatched_D0Mass_zoom << " +/- " << masserr_B_unmatched_D0Mass_zoom << std::endl;
  std::cout << "Signal width = " << width_B_unmatched_D0Mass_zoom << " +/- " << widtherr_B_unmatched_D0Mass_zoom << "\n" << std::endl;
  std::cout << "Nsig = " << Nsig_B_unmatched_D0Mass_zoom << " +/- " << dNsig_B_unmatched_D0Mass_zoom << std::endl;
  std::cout << "Nbck = " << Nbck_B_unmatched_D0Mass_zoom << " +/- " << dNbck_B_unmatched_D0Mass_zoom << std::endl;
  ...
  RooRealVar x_B_unmatched_D0combiMass_zoom("mass","D^{0} mass",1.7,2.,"GeV/c^{2}");
  RooDataHist dh_B_unmatched_D0combiMass_zoom("datahist","datahist",RooArgList(x_B_unmatched_D0combiMass_zoom),h_B_unmatched_D0combiMass_zoom,1.);
  
  // Signal+Background pdf
  RooRealVar mean_B_unmatched_D0combiMass_zoom("mean","mean",1.86484,1.84554,1.88414);
  RooRealVar sigma_B_unmatched_D0combiMass_zoom("sigma","sigma",0.0193,0.01,0.03);
  RooRealVar lambda_B_unmatched_D0combiMass_zoom("lambda", "slope", -1.7, -5., -0.7);
  RooGaussian sig_B_unmatched_D0combiMass_zoom("sig","gaussian signal",x_B_unmatched_D0combiMass_zoom,mean_B_unmatched_D0combiMass_zoom,sigma_B_unmatched_D0combiMass_zoom);
  RooExponential bck_B_unmatched_D0combiMass_zoom("bck", "exponential background", x_B_unmatched_D0combiMass_zoom, lambda_B_unmatched_D0combiMass_zoom);
  RooRealVar nsig_B_unmatched_D0combiMass_zoom("nsig","number of signal events",0.1*h_B_unmatched_D0combiMass_zoom->Integral(),0.,h_B_unmatched_D0combiMass_zoom->Integral());
  RooRealVar nbck_B_unmatched_D0combiMass_zoom("nbck","number of background events",0.9*h_B_unmatched_D0combiMass_zoom->Integral(),0.,h_B_unmatched_D0combiMass_zoom->Integral());
  RooAddPdf model_B_unmatched_D0combiMass_zoom("model","model",RooArgList(sig_B_unmatched_D0combiMass_zoom,bck_B_unmatched_D0combiMass_zoom),RooArgList(nsig_B_unmatched_D0combiMass_zoom,nbck_B_unmatched_D0combiMass_zoom)) ;

  // Fit
  model_B_unmatched_D0combiMass_zoom.fitTo(dh_B_unmatched_D0combiMass_zoom);
  double mass_B_unmatched_D0combiMass_zoom     = mean_B_unmatched_D0combiMass_zoom.getVal();
  double masserr_B_unmatched_D0combiMass_zoom  = mean_B_unmatched_D0combiMass_zoom.getError();
  double width_B_unmatched_D0combiMass_zoom    = sigma_B_unmatched_D0combiMass_zoom.getVal();
  double widtherr_B_unmatched_D0combiMass_zoom = sigma_B_unmatched_D0combiMass_zoom.getError();
  double Nsig_B_unmatched_D0combiMass_zoom  = nsig_B_unmatched_D0combiMass_zoom.getVal();
  double dNsig_B_unmatched_D0combiMass_zoom = nsig_B_unmatched_D0combiMass_zoom.getError();
  double Nbck_B_unmatched_D0combiMass_zoom  = nbck_B_unmatched_D0combiMass_zoom.getVal();
  double dNbck_B_unmatched_D0combiMass_zoom = nbck_B_unmatched_D0combiMass_zoom.getError();
  double *SNR_B_unmatched_D0combiMass_zoom = new double[2];
  SNR_B_unmatched_D0combiMass_zoom[0] = Nsig_B_unmatched_D0combiMass_zoom*pow(Nbck_B_unmatched_D0combiMass_zoom,-0.5);
  SNR_B_unmatched_D0combiMass_zoom[1]  = dNsig_B_unmatched_D0combiMass_zoom*pow(Nbck_B_unmatched_D0combiMass_zoom,-0.5) + 0.5*SNR_B_unmatched_D0combiMass_zoom[0]*dNbck_B_unmatched_D0combiMass_zoom/Nbck_B_unmatched_D0combiMass_zoom;
  std::cout << "\nSignal mean = " << mass_B_unmatched_D0combiMass_zoom << " +/- " << masserr_B_unmatched_D0combiMass_zoom << std::endl;
  std::cout << "Signal width = " << width_B_unmatched_D0combiMass_zoom << " +/- " << widtherr_B_unmatched_D0combiMass_zoom << "\n" << std::endl;
  std::cout << "Nsig = " << Nsig_B_unmatched_D0combiMass_zoom << " +/- " << dNsig_B_unmatched_D0combiMass_zoom << std::endl;
  std::cout << "Nbck = " << Nbck_B_unmatched_D0combiMass_zoom << " +/- " << dNbck_B_unmatched_D0combiMass_zoom << std::endl;
  std::cout << "SNR  = " << SNR_B_unmatched_D0combiMass_zoom[0] << " +/- " << SNR_B_unmatched_D0combiMass_zoom[1] << "\n" << std::endl;

  RooRealVar x_B_unmatched_D0unbias_zoom("mass","D^{0} mass",1.7,2.,"GeV/c^{2}");
  RooPlot* frame_B_unmatched_D0unbias_zoom = x_B_unmatched_D0unbias_zoom.frame();
  dh_B_unmatched_D0Mass_zoom.plotOn(frame_B_unmatched_D0unbias_zoom,MarkerColor(50),LineColor(50),Name("model_B_unmatched_D0Mass_zoom"));
  model_B_unmatched_D0Mass_zoom.plotOn(frame_B_unmatched_D0unbias_zoom,LineColor(50));
  dh_B_unmatched_D0combiMass_zoom.plotOn(frame_B_unmatched_D0unbias_zoom,MarkerColor(38),LineColor(38),Name("model_B_unmatched_D0combiMass_zoom"));
  model_B_unmatched_D0combiMass_zoom.plotOn(frame_B_unmatched_D0unbias_zoom,LineColor(38));
  TCanvas* cn_B_unmatched_D0unbias_zoom = new TCanvas("cn_B_unmatched_D0unbias_zoom","cn_B_unmatched_D0unbias_zoom",800,800);
  cn_B_unmatched_D0unbias_zoom->cd();
  frame_B_unmatched_D0unbias_zoom->Draw();
  TLegend *leg_B_unmatched_D0unbias_zoom = new TLegend(0.65,0.72,0.94,0.92);
  leg_style(leg_B_unmatched_D0unbias_zoom,12);
  ...
  cn_B_unmatched_D0unbias_zoom->SaveAs("Plots"+date+"/B_unmatched_D0unbias_zoom.pdf");

  if (!inBatch) getchar();
  delete cn_B_unmatched_D0unbias_zoom;

  RooRealVar x_B_unmatched_D0bias_zoom("mass","D^{0} mass",1.7,2.,"GeV/c^{2}");
  RooPlot* frame_B_unmatched_D0bias_zoom = x_B_unmatched_D0bias_zoom.frame();
  dh_B_unmatched_D0consMass_zoom.plotOn(frame_B_unmatched_D0bias_zoom,MarkerColor(47),LineColor(47),Name("model_B_unmatched_D0consMass_zoom"));
  model_B_unmatched_D0consMass_zoom.plotOn(frame_B_unmatched_D0bias_zoom,LineColor(47));
  dh_B_unmatched_D0optcombiMass_zoom.plotOn(frame_B_unmatched_D0bias_zoom,MarkerColor(30),LineColor(30),Name("model_B_unmatched_D0optcombiMass_zoom"));
  model_B_unmatched_D0optcombiMass_zoom.plotOn(frame_B_unmatched_D0bias_zoom,LineColor(30));
  TCanvas* cn_B_unmatched_D0bias_zoom = new TCanvas("cn_B_unmatched_D0bias_zoom","cn_B_unmatched_D0bias_zoom",800,800);
  cn_B_unmatched_D0bias_zoom->cd();
  frame_B_unmatched_D0bias_zoom->Draw();
  TLegend *leg_B_unmatched_D0bias_zoom = new TLegend(0.65,0.72,0.94,0.92);
  leg_style(leg_B_unmatched_D0bias_zoom,12);
  ...
  cn_B_unmatched_D0bias_zoom->SaveAs("Plots"+date+"/B_unmatched_D0bias_zoom.pdf");

  if (!inBatch) getchar();
  delete cn_B_unmatched_D0bias_zoom;

  delete h_B_D0Mass_zoom; delete h_B_D0consMass_zoom; delete h_B_D0combiMass_zoom; delete h_B_D0optcombiMass_zoom; delete h_B_unmatched_D0consMass_zoom; delete h_B_unmatched_D0optcombiMass_zoom;
  ...
  cn_genD0_n->SaveAs("Plots"+date+"/genD0_n.pdf");

  if (!inBatch) getchar();
  delete cn_nJets; delete cn_CSV; delete cn_B_cuts; delete cn_genD0_n;
  delete h_nJets; delete h_CSV; delete h_B_cuts; delete h_genD0_n;
